...
const templates_1 = require("./generator/templates");
...
function generate(filePath, className, outputDirectory) {
    ...
    for (const r of registrations) {
        const resolverCode = liquid.parseAndRenderSync(templates_1.resolverTemplate, { registration: r, outputDir: outputDirectory });
    ...
    const symbolsCode = liquid.parseAndRenderSync(templates_1.symbolsTemplate, { namespaces, symbols: allSymbols });
    ...
    const indexCode = liquid.parseAndRenderSync(templates_1.serviceProviderTemplate, { resolvers: resolvers });
