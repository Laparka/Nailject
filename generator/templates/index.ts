export const resolverTemplate = '' +
  ...
  'import { {{ registration.scope }}ServiceResolver, InstanceConstructor, ServiceResolver } from \'tsinjector/api/serviceResolver\';\n' +
  'import { ServiceProvider } from \'tsinjector/api/serviceProvider\';\n' +
  '\n' +
...
export const symbolsTemplate = 'export const TYPES = {\n' +
...
export const serviceProviderTemplate = '{%- for resolver in resolvers -%}\n' +
  ...
  'import { ServiceResolver } from \'tsinjector/api/serviceResolver\';\n' +
  '\n' +
